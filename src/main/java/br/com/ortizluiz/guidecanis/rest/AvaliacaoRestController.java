...
public class AvaliacaoRestController {
	...
	@Publico
	@RequestMapping(value = "/canil/{id}", method = RequestMethod.GET)
	public List<Avaliacao> getByCanil(@PathVariable("id") Long idCanil) {
		return repository.findByCanilId(idCanil);
	}
